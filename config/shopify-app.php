...
return [
    ...
    */
    ...
    'api_key' => env('SHOPIFY_API_KEY', 'a6c54c600199d5a63aee50218d55077b'),
    ...
    */
    ...
    'api_secret' => env('SHOPIFY_API_SECRET', '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'),
    ...
    */
    ...
    'api_scopes' => env('SHOPIFY_API_SCOPES', 'read_products,write_products,read_analytics,read_product_listings,read_customers
,read_orders'),
    ...
    */
    ...
    'api_redirect' => env('SHOPIFY_API_REDIRECT', 'https://mirrormatellc.myshopify.com/admin/apps/'.env('SHOPIFY_API_KEY').'/mirrormate_quiz/public/index.php'),
    ...
    */
    ...
    'webhooks' => [
        [
            ...
            'address' => env('SHOPIFY_WEBHOOK_1_ADDRESS', 'https://script.mirrormate.com/mirrormate_quiz/public/webhook/app-uninstalled')
        ],
    ],
